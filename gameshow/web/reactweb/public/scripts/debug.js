...
if (!window.DebugLogger) {
  window.DebugLogger = class DebugLogger {
    constructor() {
...
// Create global debug logger instance if it doesn't exist
if (!window.debugLogger) {
  window.debugLogger = new window.DebugLogger();
}

// Export a simple debug function if it doesn't exist
if (!window.showDebug) {
